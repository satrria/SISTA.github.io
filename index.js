...
// Animasi Tulisan Bergerak Sendiri
new TypeIt("#type1", {
  speed: 240,
  loop: true,
  waitUntilVisible: true,
})
  .type("Selamat datang di Web kami", { delay: 400 })
  .pause(1000)
  .delete(30)
  .type("Tentang SISTA", { delay: 400 })
  .pause(1000)
  .delete(30)
  .type("Sistem Informasi Seminar Tugas Akhir", { delay: 400 })
  .pause(1000)
  .delete(30)
  .go();
